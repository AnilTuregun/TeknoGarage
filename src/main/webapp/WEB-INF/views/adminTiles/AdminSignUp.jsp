    ...
    <form:form action="/adminpanel/addAdmin" method="POST" modelAttribute="adminForm" class="form-signin">
        ...
        <spring:bind path="userFirstname">
            <div class="form-group ${status.error ? 'has-error' : ''}">
                <form:input type="text" path="userFirstname" class="form-control" placeholder="First Name"
        ...
        <spring:bind path="userLastname">
            <div class="form-group ${status.error ? 'has-error' : ''}">
                <form:input type="text" path="userLastname" class="form-control" placeholder="Last Name"
                            autofocus="true"></form:input>
